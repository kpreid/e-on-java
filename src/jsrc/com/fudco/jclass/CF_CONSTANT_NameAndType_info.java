...
public class CF_CONSTANT_NameAndType_info extends CF_cp_info {
     ...
     *                         CONSTANT_Utf8_info object containing the name of the field or method
     *                         stored as a simple name (a Java identifier) or the special name
     *                         "<init>".
     * @param descriptor_index Index into the constant pool of the
     *                         CONSTANT_Utf8_info object containing the field or method type
     *                         signature.
     */
     ...
     *         object containing the name of the field or method being described.
     */
