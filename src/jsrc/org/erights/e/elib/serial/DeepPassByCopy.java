...
/**
 * Marker interface that declares objects to be transitively PassByCopy,
 * ie, to be transitively {@link Selfless}, Transparent, and
 * {@link PassByConstruction}.
 * <p/>
 * The {@link org.erights.e.elib.vat.BootRefHandler boot-comm-system} will
 * only pass PassByConstruction objects that are DeepPassByCopy. It does so by
 * sharing the actual object between vats, so any private mutable state, such
 * as a semantics-free cache
 * (e.g. {@link org.quasiliteral.term.Term#myHeight Term.myHeight}) had better
 * be mutated in a thread-safe fashion.
 *
