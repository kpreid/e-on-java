 ...
 */
public class RSAPublicKeySugar {

    /**
     * prevent instantation
     */
    private RSAPublicKeySugar() {
    }

    /**
     * Uses 'keyFactory.generatePublic(publicKeySpec)'
     */
    static public Object[] __optUncall(RSAPublicKey self) {
        KeyFactory kf;
        try {
        ...
        KeySpec spec;
        try {
            spec = kf.getKeySpec(self, RSAPublicKeySpec.class);
