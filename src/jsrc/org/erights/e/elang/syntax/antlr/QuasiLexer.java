...
public class QuasiLexer extends antlr.SwitchingLexer
  implements QuasiLexerTokenTypes, TokenStream {
    ...
    public final void mQUASIBODY(boolean _createToken)
    ...
    protected final void mQUASIn(boolean _createToken)
      throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
    ...
    protected final void mQUASI1(boolean _createToken)
      throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
