...
/**
 * This object filters a token stream coming from a lexer or another
 * TokenStream so that only certain token channels get transmitted to the
 * parser.
 * <p/>
...
public class TokenStreamHiddenTokenFilter extends TokenStreamBasicFilter {
    ...
    /**
     * Return the first hidden token if one appears before any monitored
     * token.
     */
