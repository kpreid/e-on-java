 ...
 * referenced. Consumption of characters is deferred.  In other words, reading
 * the next character is not done by conume(), but deferred until needed by LA
 * or LT.
 * <p/>
 *
 * @see antlr.CharQueue
...
public abstract class InputBuffer {
     ...
     * matched since the most recent mark() is no longer held by the buffer.
     * So, you either do a mark/rewind for failed predicate or mark/commit to
     * keep on parsing without rewinding the input.
     */
    public void commit() {
        nMarkers--;
    }
