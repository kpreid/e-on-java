...
public class DocBookCodeGenerator extends CodeGenerator {
    ...
    public void gen(LexerGrammar g) throws IOException {
        ...
        currentOutput =
          antlrTool.openOutputFile(grammar.getClassName() + ".sgml");
        ...
        println(
          "<para>Definition of lexer " + grammar.getClassName() +
    ...
    public void gen(ParserGrammar g) throws IOException {
        ...
        println(
          "<para>Definition of parser " + grammar.getClassName() +
          ", which is a subclass of " +
          grammar.getSuperClass() +
          ".</para>");
...
//		println("*** End of tree-walker Preamble Action");
        ...
        println(
          "<para>Definition of tree parser " + grammar.getClassName() +
          ", which is a subclass of " +
          grammar.getSuperClass() +
          ".</para>");
...
//	}
    ...
    protected void genHeader() {
        ...
        println("    <contrib>");
        println(
          "    Generated by <ulink url=\"http://www.ANTLR.org/\">ANTLR</ulink>" +
          antlrTool.version);
