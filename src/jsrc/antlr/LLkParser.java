...
public class LLkParser extends Parser {
    ...
    public LLkParser(TokenStream lexer, int k_) {
        this(new TokenMultiBuffer(lexer), k_);
    }

    /**
     * Consume another token from the input stream.  Can only write
     * sequentially! If you need 3 tokens ahead, you must consume() 3 times.
     * <p/>
