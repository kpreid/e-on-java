 ...
 */
public final class Keyspace implements org.waterken.url.tls.Keyspace,
  java.io.Serializable {
    ...
    public Certificate certify(final KeyPair identity)
      ...
      InvalidKeyException, SignatureException {
        ...
        final byte[] key_value = ((RSAPublicKey)identity.getPublic()).getEncoded();
    ...
    public Host become(final KeyPair identity) throws CertificateException,
      NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        return new Host(this, identify(identity.getPublic()), new javax.net.ssl.KeyManager[]{KeyManager.make(
          identity.getPrivate(), new X509Certificate[]{
              (X509Certificate)certify(identity)})});
    }
}
