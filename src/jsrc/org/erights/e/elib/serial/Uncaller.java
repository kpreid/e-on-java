...
public interface Uncaller {
     ...
     * it. See {@link BaseLoader#getOptWrappingUncall} for a
     * convenience to help write such wrappers.
     *
     * @return :nullOk[Tuple[any, String, List]]; either null or a 3-element
     *         list of<ul>
     *         <li>a receiver object whose reconstruction would receive the
     *             message
     *         <li>a String, which is the name of the message to call
     *         <li>a list of arguments, whose reconstruction are the actual
