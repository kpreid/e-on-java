...
/**
 * Entries in a TraversalKey's fringe. Each FringeNode stores the identity of
 * one promise and the location at which it was found in a structure.
 *
 * @author Kevin Reid
 */
class FringeNode {
    private Object myIdentity;
    private FringePath myPath;
