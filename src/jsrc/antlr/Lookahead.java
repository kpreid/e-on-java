 ...
 * are fewer than k lookahead terminals before the end of the the rule, epsilon
 * will be returned (don't want to pass the end of the rule).  We must track
 * when the the lookahead got stuck.  For example,
 * <pre>
 * 		a : b A B E F G;
 * 		b : C ;
 * </pre>
 ...
 * 3-(3-1) and 3-(3-2).  Those are the lookahead depths past the rule ref
 * needed for the local follow.
 * <p/>
 * <p/>
