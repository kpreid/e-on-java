 ...
 *
 * $Id: //depot/code/org.antlr/release/antlr-2.7.5/antlr/JavaCharFormatter.java#1 $
 */
...
class JavaCharFormatter implements CharFormatter {
     ...
     * @param forCharLiteral true to escape for char literal, false for string
     *                       literal
     */
    ...
    /**
     * Converts a String into a string literal This works for languages that
     * use double-quotes for string literals. Code-generators for languages
