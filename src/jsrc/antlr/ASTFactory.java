...
public class ASTFactory {
     ...
     * <p/>
     * and it tracks everything statically.  #[PLUS] will make you a PLUSNode
     * w/o use of this table.
     * <p/>
     * For tokens that ANTLR cannot track statically like #[i], you can use
     * this table to map PLUS (Integer) -> PLUSNode (Class) etc... ANTLR sets
     * the class map from the tokens {...} section via the
     * ASTFactory(Hashtable) ctor in antlr.Parser.
     */
     ...
     * type.  Your subclasses of ASTFactory can override and reuse the map
     * stuff.
     */
     ...
     * ANTLR does it's best to statically determine the node type for
     * generating parsers, but it cannot deal with dynamic values like
     * #[LT(1)].  In this case, it relies on the mapping.  Beware differences
     * in the tokens{...} section and what you set via this method.  Make sure
     * they are the same.
     * <p/>
     ...
     * creation routine for backward compatibility.  Before, ANTLR generated
     * "new T(tokenObject)" and so I must call the appropriate constructor not
     * T().
     *
     * @since 2.7.2
     */
     ...
     * then setASTFactory in Parser and TreeParser.  This method removes a
     * prior dependency on class antlr.Tool.
     */
