 ...
 * <p/>
 * A tree with PLUS at the root and with two children 3 and 4 is structured
 * as:
 * <p/>
 * PLUS | 3 -- 4
 * <p/>
 ...
 * of the children lists.  They are also very easy to walk automatically,
 * whereas trees with specific children reference fields can't easily be walked
 * automatically.
 * <p/>
...
//        siblingWalk:
        for (sibling = this;
            ...
            if (sibling.getFirstChild() != null) {
                ((BaseAST)sibling.getFirstChild()).doWorkForFindAll(v,
                                                                    target,
                                                                    partialMatch);
            }
        }
    ...
    /**
     * Is 't' a subtree of the tree rooted at 'this'?  The siblings of 'this'
     * are ignored.
     */
    ...
    /**
     * Walk the tree looking for all subtrees.  Return an ASTEnumerator that
     * lets the caller walk the list of subtree roots found herein.
     */
