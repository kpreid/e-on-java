...
public class DefineGrammarSymbols implements ANTLRGrammarParseBehavior {
    ...
    /**
     * Define a token from tokens {...}. Must be label and literal or just
     * label or just a literal.
     */
    ...
    /**
     * Called after the optional options section, to compensate for options
     * that may not have been set. This method is bigger than it needs to be,
     * but is much more clear if I delineate all the cases.
     */
