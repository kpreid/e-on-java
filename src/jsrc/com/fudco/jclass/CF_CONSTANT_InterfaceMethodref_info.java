...
/**
 * Constant pool entry describing a reference to a method of an interface.
 */
public class CF_CONSTANT_InterfaceMethodref_info extends CF_cp_ref {
    ...
    static CF_CONSTANT_InterfaceMethodref_info read(DataInputStream in)
      throws IOException {
        ...
        return new CF_CONSTANT_InterfaceMethodref_info(class_index,
                                                       name_and_type_index);
    }
}
