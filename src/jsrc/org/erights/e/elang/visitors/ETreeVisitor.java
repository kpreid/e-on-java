...
/**
 * Implementors of this interface are <i>visitors</i> for visiting Expanded-E,
 * Kernel-E, Bound-E, or Transformed-E ASTs. <ul> <li>E - syntactic sugar =
 * Expanded-E. <li>Expanded-E + fully qualified names = Kernel-E. <li>Kernel-E
 * + syntactic environments = Bound-E. <li>Bound-E + optimizations + internal
 * ScopeLayout info + variable location info = Transformed-E. </ul> Kernel-E is
 ...
 * <p/>
 * The notion of <i>visitor</i> used here is a variation of that defined by the
 * <i>Visitor Pattern</i> of the Design Patterns book. Here, each visit method
 * has both an optional first parameter (<tt>optoriginal</tt>), which is the
 * original node being visited, and a set of arguments, which between them
 * contain all the non-debugging information present in a Kernel-E tree. For a
 * Kernel-E tree, the <tt>optOriginal</tt> parameter, if present, additionally
 * contributes only source position information.
 *
...
public interface ETreeVisitor {
     ...
     *
     * @see <a href="{@docroot}/../elang/kernel/CallExpr.html">The Kernel-E
     *      Call Expression</a>
     */
     ...
     * <p/>
     * Match patt against the value of rValue. Neither patt nor rValue may use
     * any variables defined by the other. This allows their scopes to be order
     * independent.
     *
     * @see <a href="{@docroot}/../elang/kernel/DefineExpr.html">The Kernel-E
     *      Define Expression</a>
     */
     ...
     * early, and the run argument will be the value. If run/0 is called, it's
     * as if run(null) were called.
     *
     * @see <a href="{@docroot}/../elang/kernel/EscapeExpr.html">The Kernel-E
     *      Escape Expression</a>
     */
     ...
     * surrounding scope.
     *
     * @see <a href="{@docroot}/../elang/kernel/HideExpr.html">The Kernel-E
     *      Hide Expression</a>
     */
     ...
     *
     * @see <a href="{@docroot}/../elang/kernel/IfExpr.html">The Kernel-E If
     *      Expression</a>
     */
     ...
     *
     * @see <a href="{@docroot}/../elang/kernel/LiteralExpr.html">The Kernel-E
     ...
     * continue.
     * <p/>
     * At runtime, given an auditor and an instance of an ObjectExpr audited by
     * that auditor, it must be possible to unspoofably ask that auditor
     * whether this is such an instance.
     *
     * @see <a href="{@docroot}/../elang/kernel/ObjectExpr.html">The Kernel-E
     *      Object Expression</a>
     */
     ...
     *
     * @see <a href="{@docroot}/../elang/kernel/SeqExpr.html">The Kernel-E
     *      Sequence Expression</a>
     */
     ...
     *
     * @see <a href="{@docroot}/../elang/kernel/CatchExpr.html">The Kernel-E
     *      Try-Catch Expression</a>
     */
     ...
     * abrupt termination (throw or escape), in all cases evaluate the unwinder
     * before leaving. If attempt succeeds, then the value of the
     * finally-expression is the value of attempt.
     *
     * @see <a href="{@docroot}/../elang/kernel/FinallyExpr.html">The Kernel-E
     *      Try-Finally Expression</a>
     */
     ...
     *
     * @see <a href="{@docroot}/../elang/kernel/FinalPattern.html">The Kernel-E
     *      Final Pattern</a>
     */
     ...
     *
     * @see <a href="{@docroot}/../elang/kernel/VarPattern.html">The Kernel-E
     *      Var Pattern</a>
     */
     ...
     *
     * @see <a href="{@docroot}/../elang/kernel/SlotPattern.html">The Kernel-E
     *      Slot Pattern</a>
     */
     ...
     * "["pattern*, "]". <p>
     * <p/>
     * Is the specimen a list exactly this long, and do each of the elements
     * match the corresponding sub-pattern?
     *
     * @see <a href="{@docroot}/../elang/kernel/ListPattern.html">The Kernel-E
     *      Tuple Pattern</a>
     */
     ...
     * <p/>
     * A placeholder in a quasi-pattern-parseTree to capture a corresponding
     * pattern in a specimen parseTree, and say where to put it in the binding
     * vector. Not part of Kernel-E.
     */
     ...
     * visitObjectExpr, instead an eScript is provided whose optMethods is
     * null. This breaks the XML translation, since the XML encoding cannot
     * distinguish between no method and an empty list of methods.
     *
     * @see <a href="{@docroot}/../elang/kernel/EScript.html">The Kernel-E
     *      Script Node</a>
     */
    ...
    /**
     * "##" docComment <br> "to" verb "(" patterns*, ")" (":" optResultGuard)?
     * "{" body "}".
     * <p/>
     * Defines a method for verb and a number of arguments matching the number
     * of patterns. When the containing object is sent such a message, the
     * arguments are matched against the patterns, and then the body is
     * evaluated. They value of body as coerced by optResultGuard is finally
     * revealed.
     *
     * @see <a href="{@docroot}/../elang/kernel/EMethod.html">The Kernel-E
     *      Method Node</a>
     */
     ...
     * <p/>
     * When the incoming message doesn't fit any of the methods, then a pair of
     * the verb and the arguments is matched against patt, then body is
     * evaluated, and it value revealed.
     *
     * @see <a href="{@docroot}/../elang/kernel/EMatcher.html">The Kernel-E
     *      EMatcher Node</a>
     */
    Object visitEMatcher(ENode optOriginal, Pattern pattern, EExpr body);
}
