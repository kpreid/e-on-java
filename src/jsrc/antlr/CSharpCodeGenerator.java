...
//    private java.util.Vector astTypes;
    ...
    static private CSharpNameSpace nameSpace = null;
...
// this allows us to do usefull EOF checking...
    ...
    protected void genAlt(Alternative alt, AlternativeBlock blk) {
        ...
        if (genAST) {
            if (blk instanceof RuleBlock) {
                ...
                antlrTool.warning("Labeled subrules not yet supported",
                                  grammar.getFilename(),
                                  blk.getLine(),
                                  blk.getColumn());
            }
    ...
    private void genBitSet(BitSet p, int id) {
        // initialization data
        println("static private long[] mk_" + getBitsetName(id) + "()");
        println("{");
        tabs++;
        ...
        println("}");
        // BitSet object
        println("static public readonly BitSet " + getBitsetName(id) +
        ...
        if (howToFinish.postscript != null) {
            if (howToFinish.needAnErrorClause && howToFinish.generatedSwitch &&
              !howToFinish.generatedAnIf && noViableAction != null) {
                ...
                if (0 == noViableAction.indexOf("throw") ||
                  0 == noViableAction.indexOf("goto")) {
    ...
    public void genBody(LexerGrammar g) throws IOException {
        ...
        if (grammar.debuggingOutput) {
            println(
              " : this(new LexerSharedInputState(new antlr.debug.DebuggingInputBuffer(ib)))");
        } else {
        ...
        if (grammar.debuggingOutput) {
            println(
              "static private readonly string[] _ruleNames = new string[] {");
...
//        astTypes = new java.util.Vector();
     ...
     * and EOF in the lookahead set reduces the depth of the lookahead.  @param
     * blk The block to generate @param noTestForSingle If true, then it does
     * not generate a test for a single alternative.
     */
...
// clear list of declared ast variables..
    ...
    public void genTokenStrings() {
        ...
        println("");
        println("static public readonly string[] tokenNames_ = new string[] {");
        tabs++;
    ...
    private String getValueString(int value) {
        ...
        if (grammar instanceof LexerGrammar) {
            ...
            if (ts == null) {
                ...
                // antlrTool.fatalError("vocabulary for token type " + value + " is null");
            }
            String tId = ts.getId();
...
//					System.out.println("returning null (rulename)");
        ...
        if (g instanceof ParserGrammar) {
            ...
            if (!g.hasOption("ASTLabelType")) {
                g.setOption("ASTLabelType",
                            new Token(ANTLRTokenTypes.STRING_LITERAL, "AST"));
            }
            labeledElementInit = "null";
            commonExtraArgs = "_t";
     ...
     * file in its own evil way.  JavaCodeGenerator simply opens a text
     * file...
     */
     ...
     */
    static private String OctalToUnicode(String str) {
