...
public class ANTLRParser extends antlr.LLkParser implements ANTLRTokenTypes {
    ...
    /**
     * Match a.b.c.d qualified ids; WILDCARD here is overloaded as id
     * separator; that is, I need a reference to the '.' token.
     */
            ...
            case RANGE:
                {
                    ...
                    if (inputState.guessing == 0) {
                        ...
                        int rangeMax = ANTLRLexer.tokenTypeForCharLiteral(
                          c2.getText());
                        if (rangeMax < rangeMin) {
                            antlrTool.error("Malformed range line ",
                                            getFilename(),
                                            c1.getLine(),
                                            c1.getColumn());
                        }
            ...
            if ((LA(1) == TOKEN_REF || LA(1) == RULE_REF) &&
              ...
              (_tokenSet_5.member(LA(2)))) {
                ...
                }
                {
                    ...
                    default:
                        if ((LA(1) == STRING_LITERAL || LA(1) == CHAR_LITERAL ||
                          LA(1) == TOKEN_REF) &&
                          (LA(2) == RANGE)) {
                            range(label);
    ...
    public final void tree() throws RecognitionException,
      TokenStreamException {
