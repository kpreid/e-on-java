 ...
 * the
 * {@link org.erights.e.elang.interp.ScopeSetup#NonShadowable NonShadowable}
...
public interface Evaluator {
     ...
     * happen when eval() is invoked synchronously.
     */
     ...
     * problem report is thrown on failure, and bindingsOut should be ignored.
     * @param bindingsOut Provides a mapping from variable names to
