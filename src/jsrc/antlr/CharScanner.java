...
public abstract class CharScanner implements TokenStream {
    ...
    public void match(String s)
      throws MismatchedCharException, CharStreamException {
        ...
        for (int i = 0; i < len; i++) {
            if (LA(1) != s.charAt(i)) {
                throw new MismatchedCharException(LA(1),
                                                  s.charAt(i),
                                                  false,
                                                  this);
            }
     ...
     * to perform a different literals test This is used primarily when you
     * want to test a portion of a token.
     */
    ...
    /**
     * This method is called by YourLexer.nextToken() when the lexer has hit
     * EOF condition.  EOF is NOT a character. This method is not called if EOF
     * is reached during syntactic predicate evaluation or during evaluation of
