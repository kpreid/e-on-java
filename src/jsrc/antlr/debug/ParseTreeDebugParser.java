 ...
 * trees.  This class is useful for 2.7.3 where you can specify a superclass
 * like
 * <p/>
...
public class ParseTreeDebugParser extends LLkParser {
    ...
    /**
     * Each new rule invocation must have it's own subtree.  Tokens are added
     * to the current root so we must have a stack of subtree roots.
     */
     ...
     * alternative errors, no node will be in the tree as nothing was matched()
