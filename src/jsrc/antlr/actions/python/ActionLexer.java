 ...
 * <p/>
 * $append(x)     -> self.text.append(x) $setText(x)    ->
 * self.text.setLength(_begin) self.text.append(x) $getText       ->
 * self.text.getString(_begin) $setToken(x)   -> _token = x $setType(x)    ->
 * _ttype = x $FOLLOW(r)     -> FOLLOW set name for rule r (optional arg)
 * $FIRST(r)      -> FIRST set name for rule r (optional arg)
 * <p/>
 * experimental: $newline, $nl  -> self.newline() $skip          -> _ttype =
 * SKIP
 */
  ...
  implements ActionLexerTokenTypes {
    ...
    protected final void mTEXT_ITEM(boolean _createToken)
      throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        if (('$' == LA(1)) && ('s' == LA(2)) && ('e' == LA(3))) {
            ...
            {
                if (('$' == LA(1)) && ('n' == LA(2)) && ('l' == LA(3))) {
                    match("$nl");
                } else
                if (('$' == LA(1)) && ('n' == LA(2)) && ('e' == LA(3))) {
                    match("$newline");
                } else {
                    throw new NoViableAltForCharException((char)LA(1),
                                                          getFilename(),
        ...
        }
        {
            ...
            case']': {
...

                {
                    ...
                    if ((_tokenSet_17.member(LA(1))) && (true) && (true)) {
                    } else {
                        throw new NoViableAltForCharException((char)LA(1),
                                                              getFilename(),
                                                              getLine(),
    ...
    protected final void mINT_OR_FLOAT(boolean _createToken)
      throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        {
            if (('L' == LA(1)) && (_tokenSet_25.member(LA(2))) && (true)) {
                match('L');
            } else
            if (('l' == LA(1)) && (_tokenSet_25.member(LA(2))) && (true)) {
                match('l');
