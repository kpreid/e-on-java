 ...
 * synchronize the event firing and add/remove listener methods.  This is
 * because the add/remove should _only_ be called by the parser at its
 * start/end, and the _same_thread_ should be performing the parsing.  This
 * should help performance a tad...
 */
...
//		Hashtable targets=doneListeners;
    ...
    public void fireEvent(int type, ListenerBase l) {
        ...
        case SEMPRED:
            ((SemanticPredicateListener)l).semanticPredicateEvaluated(
              semPredEvent);
            break;

        case SYNPRED_STARTED:
            ((SyntacticPredicateListener)l).syntacticPredicateStarted(
              synPredEvent);
            break;
        case SYNPRED_FAILED:
            ((SyntacticPredicateListener)l).syntacticPredicateFailed(
              synPredEvent);
            break;
        case SYNPRED_SUCCEEDED:
            ((SyntacticPredicateListener)l).syntacticPredicateSucceeded(
              synPredEvent);
            break;
    ...
    public void fireMatch(char c, int guessing) {
        matchEvent.setValues(ParserMatchEvent.CHAR,
                             c,
                             new Character(c),
                             null,
                             guessing,
    ...
    public void fireMatch(char value, BitSet b, int guessing) {
        matchEvent.setValues(ParserMatchEvent.CHAR_BITSET,
                             value,
                             b,
                             null,
                             guessing,
    ...
    public void fireMatch(char value, String target, int guessing) {
        matchEvent.setValues(ParserMatchEvent.CHAR_RANGE,
                             value,
                             target,
                             null,
                             guessing,
    ...
    public void fireMatch(int value, BitSet b, String text, int guessing) {
        matchEvent.setValues(ParserMatchEvent.BITSET,
                             value,
                             b,
                             text,
                             guessing,
    ...
    public void fireMatch(int n, String text, int guessing) {
        matchEvent.setValues(ParserMatchEvent.TOKEN,
                             n,
                             new Integer(n),
                             text,
                             guessing,
    ...
    public void fireMatch(String s, int guessing) {
        matchEvent.setValues(ParserMatchEvent.STRING,
                             0,
                             s,
                             null,
                             guessing,
