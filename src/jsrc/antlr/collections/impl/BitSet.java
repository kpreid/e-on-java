 ...
 * operators return new sets as opposed to oring and anding "in place".
 * Further, a number of operations were added.  I cannot contain a BitSet
 * because there is no way to access the internal bits (which I need for speed)
 * and, because it is final, I cannot subclass to add functionality. Consider
 * defining set degree.  Without access to the bits, I must call a method n
 * times to test the ith bit...ack!
 * <p/>
...
public class BitSet implements Cloneable {
    ...
    /**
     * Find ranges in a set element array.  @param elems The array of elements
     * representing the set, usually from Bit Set.toArray().
     *
